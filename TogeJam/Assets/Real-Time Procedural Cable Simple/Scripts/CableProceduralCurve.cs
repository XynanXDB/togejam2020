...
public class CableProceduralCurve : MonoBehaviour
{
	...
	[SerializeField, Tooltip("Positive keys are applied downward on cable.  Recommended use is to have keys at 0 at the start and end of the curve.")] protected AnimationCurve curve;
